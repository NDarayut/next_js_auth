...
export async function POST(req) {
    try{
        ...
        const {firstName, lastName, email, password, role = "user"} = await req.json() // get the request sent from the RegisterForm and store it in the var
        ...
        await User.create({firstName, 
                            ...
                            role}) // input the detail into database
